...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view
{
    ...
    NSString *text;
    if (component == 0) {
        text =  [NSString stringWithFormat:@"%d", row + 2016];
    }else if (component == 1){
...
- (void)selectedOk
{
    ...
    [kNotiCenter postNotificationName:@"sureoperation" object:@"sure" userInfo:@{@"viewtag":@567, @"content":[NSString stringWithFormat:@"%ld-%ld-%ld",_year,_month,_day]}];

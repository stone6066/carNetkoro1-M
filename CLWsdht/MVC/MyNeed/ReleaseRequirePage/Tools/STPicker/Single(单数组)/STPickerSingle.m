...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view
{
    ...
    if (component == 0) {
        ...
        [label setText:[NSString stringWithFormat:@"%@", self.arrayData[row]]];
...
- (void)selectedOk
{
    [kNotiCenter postNotificationName:@"sureoperation" object:@"sure" userInfo:@{@"viewtag":@565, @"content":_selectedTitle}];
    [super selectedOk];
}
